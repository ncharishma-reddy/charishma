...
const songs = [
    ...
    // {
    //     id: '9',
    //     songName: `Bisilu-Kudure-Ondu<br>
    //     <div class="subtitle">Rajesh Krishnan</div>`,
    //     poster: "img/7.jpg"
    // },
    {
        id: '10',
...
var playlists = {
    ...
    love: {
        folk: [
            { title: "Aradhya", link: "audio/6.mp3"},
            { title: "Mere Yaara", link: "audio/7.mp3" },
            { title: "Ishq Wala Love", link: "audio/3.mp3" },
                   
        ],
        film: [
            { title: "Mastaru Mastaru", link: "audio/16.mp3" }, 

            { title: "Kesariya", link: "audio/4.mp3" },
            { title: "Heeriye", link: "audio/1.mp3" },
        ],
        indian_rock: [
            { title: "Chaleya", link: "audio/10.mp3" },
            { title: "Dilbar", link: "audio/12.mp3" },             
             { title: "Jilka Jilka", link: "audio/14.mp3" },
        ],
